  ...
  return (
    <div className="card">
      <div className="card-img flex-center">
        <img
          src={
            (currentDoctor?.user?.pic ?? currentDoctor?.user[0]?.pic) ||
            defaultProfilePic
          }
          alt="profile"
        />
      ...
      <h3 className="card-name">
        Dr.{" "}
        {currentDoctor?.user?.firstName ?? currentDoctor?.user[0]?.firstName}{" "}
        {currentDoctor?.user?.lastName ?? currentDoctor?.user[0]?.lastName}
      </h3>
